...
$(function () {
    ...
    if (window.location.href.indexOf('http://www.cgamex.com/static/scripts/detail.html') > -1) {
...
var down_fun = function (gameId) {
    ...
    if (selfGameInfo == null || selfGameInfo == undefined || selfGameInfo == "") {
        ...
        if (selfGameInfo.url_ios1 == "" && selfGameInfo.url_ios2 == "") {
            ...
            var modalHeight = $("http://www.cgamex.com/static/scripts/div.dpm").height();

            $("http://www.cgamex.com/static/scripts/div.dpm").css({"top": windowHeight / 4});
